...
goog.addDependency("../tic_tac_toe/ai_player.js", ['tic_tac_toe.ai_player'], ['tic_tac_toe.tic_tac_toe_board', 'tic_tac_toe.symbols', 'tic_tac_toe.win_checker', 'cljs.core']);
goog.addDependency("../tic_tac_toe/turn_system.js", ['tic_tac_toe.turn_system'], ['tic_tac_toe.tic_tac_toe_board', 'tic_tac_toe.ui_interface', 'tic_tac_toe.ai_player', 'cljs.core']);
...
goog.addDependency("../tic_tac_toe/web_ui_spec.js", ['tic_tac_toe.web_ui_spec'], ['speclj.core', 'tic_tac_toe.game_runner', 'tic_tac_toe.web_ui', 'tic_tac_toe.ui_interface', 'tic_tac_toe.option_selector', 'clojure.string', 'cljs.core']);
goog.addDependency("../tic_tac_toe/win_checker_spec.js", ['tic_tac_toe.win_checker_spec'], ['tic_tac_toe.win_checker', 'speclj.core', 'cljs.core']);
goog.addDependency("../tic_tac_toe/option_selector_spec.js", ['tic_tac_toe.option_selector_spec'], ['tic_tac_toe.option_selector', 'speclj.core', 'cljs.core']);
goog.addDependency("../tic_tac_toe/main.js", ['tic_tac_toe.main'], ['tic_tac_toe.ui_interface', 'tic_tac_toe.web_ui', 'cljs.core']);
goog.addDependency("../tic_tac_toe/tic_tac_toe_board_spec.js", ['tic_tac_toe.tic_tac_toe_board_spec'], ['tic_tac_toe.tic_tac_toe_board', 'speclj.core', 'cljs.core']);
goog.addDependency("../tic_tac_toe/core_spec.js", ['tic_tac_toe.core_spec'], ['speclj.core', 'tic_tac_toe.main', 'cljs.core']);
goog.addDependency("../tic_tac_toe/turn_system_spec.js", ['tic_tac_toe.turn_system_spec'], ['tic_tac_toe.turn_system', 'tic_tac_toe.ai_player', 'tic_tac_toe.tic_tac_toe_board', 'tic_tac_toe.ui_interface', 'speclj.core', 'cljs.core']);
goog.addDependency("../tic_tac_toe/symbols_spec.js", ['tic_tac_toe.symbols_spec'], ['tic_tac_toe.symbols', 'speclj.core', 'cljs.core']);
goog.addDependency("../tic_tac_toe/ai_player_spec.js", ['tic_tac_toe.ai_player_spec'], ['tic_tac_toe.ai_player', 'speclj.core', 'cljs.core']);
